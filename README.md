...
![Slice Mania Banner](assets/images/slice-mania-banner.png)

**Slice Mania** is an exhilarating, endless mobile game built with Unity 6, inspired by *Fruit Ninja*. Slice through a cascade of falling candies with swift swipes, earning points as each candy splits into two smaller ones, intensifying the challenge! Miss a candy and let it hit the bottom, and you’ll lose one of your three lives—lose all, and it’s game over. Optimized for iOS and Android, with WebGL support for browser play on touch devices, this game combines addictive gameplay with ad monetization. Play it now on [itch.io](https://xAgesx.itch.io/) or build it from the `/build` folder!

This project highlights my expertise in Unity 6, mobile-first game development, touch input systems, and ad integration—perfect for employers seeking a skilled Unity developer for engaging mobile experiences.
...
**Note**: Ensure assets (sprites, audio) are correctly referenced. Missing files? Check the `Assets` folder or contact me.
...
*Slicing candies mid-air with particles flying.*  

![Game Over Screen](assets/images/screenshot-gameover.png)  
*High score display with retry prompt.*  
...
- **Ad Integration**: Monetized with Unity Ads, including interstitials and rewarded ads for extra lives.
- **Cross-Platform**: Optimized for iOS and Android, with WebGL for browser play on touch devices. Includes a Windows `.exe` for testing.
- **Performance**: Efficient memory management ensures smooth gameplay, even with numerous candies on screen.

## Why This Project?

*Slice Mania* is a testament to my ability to craft polished, mobile-first games in Unity 6. It showcases:
- **Mobile Expertise**: Optimized touch controls and performance for iOS and Android.
- **Monetization**: Seamless Unity Ads integration for real-world application.
- **Gameplay Design**: Engaging, endless mechanics that balance simplicity and challenge.
- **Cross-Platform Delivery**: Support for mobile, web, and desktop testing environments.

As a Unity developer, I’m passionate about creating fun, scalable games. This project is a portfolio highlight for employers looking for skills in mobile game development, input systems, and monetization. Let’s connect to build something exciting!
...
- **Monetization**: Unity Ads SDK for ads and rewarded videos.
